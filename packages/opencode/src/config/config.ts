...
export const Info = z
  .object({
    ...
    storage: z
      .object({
        database: z.string().optional().describe("Custom path for database file"),
        log: z.string().optional().describe("Custom path for log directory"),
        worktree: z.string().optional().describe("Custom path for worktree directory"),
        snapshot: z.string().optional().describe("Custom path for snapshot directory"),
      })
      .optional()
      .describe("Custom storage paths for database, logs, worktrees, and snapshots"),
  })
  .strict()
  .meta({
    ref: "Config",
