export const dict = {
  ...
  "settings.general.section.worktree": "Workspace",
  "settings.general.row.worktree.path": "Workspace directory",
  "settings.general.row.worktree.copy": "Copy path",
  "settings.general.section.snapshot": "Snapshot",
  "settings.general.row.snapshot.path": "Snapshot directory",
  "settings.general.row.snapshot.copy": "Copy path",
