...
export const dict = {
  ...
  "status.popover.currentProject": "当前项目",
  ...
  "settings.data.section.log": "日志",
  "settings.data.row.log.path": "日志目录",
  "settings.data.row.log.copy": "复制路径",
  "settings.general.section.worktree": "工作区",
  "settings.general.row.worktree.path": "工作区目录",
  "settings.general.row.worktree.copy": "复制路径",
  "settings.general.section.snapshot": "快照",
  "settings.general.row.snapshot.path": "快照目录",
  "settings.general.row.snapshot.copy": "复制路径",
